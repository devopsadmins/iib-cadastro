<x-report-page
    title="Especialistas vinculados na Onda 1"
    subtitle="Lista dos especialistas associados apenas a primeira onda." 
    badge="Relatorios de especialistas"
    count-label="Especialistas"
    :count="$rows->count()"
>
    <x-slot:meta>
        <span class="rounded-full border border-white/10 bg-white/10 px-3 py-1 text-xs text-slate-200">Filtro: Onda 1</span>
    </x-slot:meta>
